...
`status: done` · added 2026-08-30 · shipped at build 141 · verified at build 356
...
**Verification note — `/ccc` at build 356. Superseded twice over.** Its three screen thirds are gone — entry 52 retired them, and `main.ts:1199` still carries the note that the zone argument is now a fixed empty string "carrying nothing" — and the saving those thirds gated is gone too, with entry 103. What survives is the clause the entry was actually about: `stopPropagation()` no longer appears in any tap path, only in the comments explaining why it does not and on a chip's own listener. One recogniser still owns the picture's taps; the map of the picture it used has been thrown away.
### 42. The fullscreen chip moves to the centre of the screen
`status: done` · added 2026-08-30 · shipped at build 157 · verified at build 356
...
`status: done` · added 2026-08-30 · shipped at build 159 · verified at build 356
...
`status: done` · added 2026-08-30 · shipped at build 165 · verified at build 356
...
`status: done` · added 2026-08-30 · shipped at build 166 · verified at build 356
...
**Verification note — `/ccc` at build 356.** Holds, and has since been tightened rather than loosened: `SUSPEND` is still 30, `?auto=0` still produces a session where nothing changes on its own, and the autopilot chip is gone from the arc (the two remaining `'auto'` strings in `hud.ts` belong to the sky override, not to this). The colour hold this entry set at 30s is now 25 — entry 84 split the two holds so the layers stop changing in lockstep. This entry's promise that the director *never waits more than 30s* turned out to be true of one condition and not of the outcome, which is what entry 89 found and fixed; both are archived here.
### 46. Three taps on the gate open the powder
`status: done` · added 2026-08-30 · shipped at build 180 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 143 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 146 · verified at build 356
...
**Verification note — `/ccc` at build 356.** Holds, and its probe has kept pace with the registry: `probe-composite` now asserts *atmAlpha 0 matches geometry alone* under all **seven** merge modes, XOR included, so entry 105's new mode was folded into the existing guard rather than left uncovered. The regression fixtures for the old formula's black frame are still there. One thing this entry did not reach, found much later: the same zero-opacity argument applies to a layer over the **camera**, and did not hold there until entry 95 (build 317).
### 35. A light shake nudges the picture instead of repainting it
`status: done` · added 2026-08-30 · shipped at build 148 · verified at build 356
...
`status: done` · added 2026-08-30 · shipped at build 149 · verified at build 356
...
**Verification note — `/ccc` at build 356.** Both violent cases report depth 1.00 as required. The deliberate case reports 0.55 rather than the 0.54 named here — a deliberate later change, not drift: entry 85 (build 294) reworked how depth is measured so a deliberate shake reads the same at 12, 20 and 30 Hz instead of falling off with rate, and 0.55 is that single figure.
### 37. A harness that plays a song at the views
`status: done` · added 2026-08-30 · shipped at build 150 · verified at build 356
...
`status: done` · added 2026-08-30 · shipped at build 153 · verified at build 356
...
`status: done` · added 2026-08-30 · shipped at build 154 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 117 · verified at build 356
...
**Verification note — `/ccc` at build 356.** The uniqueness mechanism is intact and still needed. `saveCapture` stamps `YYYYMMDD-HHMMSS-NN` from a per-session `captureCount`, all local-clock, so five shots in one second still sort in order and never collide — the seconds field alone would not have been enough. The *gesture* the Done-when names is gone (entry 103 removed tap-to-save), but the naming it was really about applies unchanged to camera mode's shutter, which is now the only path here.
### 27. Swipes stop changing the picture; the shake is the gesture
`status: done` · added 2026-08-29 · shipped at build 119 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 120 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 121 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 126 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 127 · verified at build 356
...
**Verification note — `/ccc` at build 356.** The seam holds and has since acquired a second consumer, which is the sign it was the right shape: `createHud` takes `debugFromUrl` and keeps it in a session-local `showStats` that is never written back to `prefs`, and `main.ts`'s shake flash reads `panel.showingStats()` rather than `prefs.showStats` precisely so a `?debug` load gets the diagnostic without it persisting past a reload. `showStats` remains the only stored field, unchanged in type and meaning.
### 32. The lattice hears the tune but not the beat
`status: done` · added 2026-08-29 · shipped at build 137 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 105 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 106 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 108 · verified at build 356
...
**Verification note — `/ccc` at build 356.** The floor holds and has since been raised past what this entry asked for: `SHUFFLE_MIN_ALPHA` is 0.5, and `main.ts`'s own comment records the arithmetic — 0.5 alpha × the roll's guaranteed colour peak of 1 gives 0.5, against this entry's 0.25 target, "for free". The finding that made it necessary is the one worth keeping: what goes dark is the *product* of opacity and colour, not either alone, which is why flooring opacity at 0.35 was not enough.
### 22. A hard shake may raise the camera
`status: done` · added 2026-08-29 · shipped at build 112 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 123 · verified at build 356
...
**Verification note — `/ccc` at build 356.** Both halves hold, and the structure has since been generalised rather than disturbed. `sampleAmbientLight` still does no readback at all with the camera down — the guard is the first line — and still throttles to one sample every 30 frames when it is up, because a per-frame readback stalls the pipeline. Entry 98 (build 319) added a second branch above that guard for the ambient-light sensor, so the camera-down case is now an answer rather than a no-op; with no sensor, `uExposure` is exactly 1 and this entry's behaviour is unchanged.
### 24. The fullscreen chip cannot be hidden, so it arrives at Start and stays
`status: done` · added 2026-08-29 · shipped at build 113 · verified at build 356
...
`status: done` · added 2026-08-29 · shipped at build 115 · verified at build 356
...
**Verification note — `/ccc` at build 356. Superseded on both counts.** The chip is no longer in the top-left utility corner — entry 42 moved it to the middle of the screen, on Victor's call made against the built result on a phone rather than against a description of it. And the panel no longer shows six chips: entry 77 split them into two rings of four. What survives is the principle underneath, that nothing reserves a slot for a chip that is not there.

### 1. Make the shake's buzz actually perceptible
`status: done` · added 2026-08-29 · shipped at build 68 — awaiting Victor's phone · verified at build 357
...
**Verification note — `/ccc` at build 357.** The code holds: `haptics.ts` is wired, called from `main.ts`, and `probe-haptics` passes. What this entry and its whole family (8, 11, and entry 40, still blocked) never achieved is the thing itself — the buzz has never been observed to work on Victor's phone, eight attempts over two days, and browser vibration was abandoned rather than re-tuned. `CONFIRM_PATTERN` and `DOUBLE_PATTERN` are not to be touched again. Verified as *built*, not as *working*, and the distinction is the entire point of entry 40 staying open.
### 2. Record that the gate carries no privacy line
`status: done` · added 2026-08-29 · closed at build 68 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 84 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 85 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 88 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 77 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 90 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 91 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 81 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 86 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 82 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 94 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 96 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 97 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 98 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 99 · verified at build 357
...
`status: done` · added 2026-08-29 · shipped at build 101 · verified at build 357
...
**Verification note — `/ccc` at build 357.** Holds, and holds in every shader written since. The fix is `min(uResolution.x, uResolution.y)` as the uv divisor so a circle stays circular on any aspect, and every geometric shader added afterwards — drift, chorus, tide, and Rose at entry 101 — uses the same line. A convention that propagated by being read rather than by being enforced.
### 18. A tap along the bottom saves the frame
`status: done` · added 2026-08-29 · shipped at build 102 · verified at build 357
...
**Verification note — `/ccc` at build 357. Superseded.** The bottom band this entry created is gone: `main.ts:564` still carries its own note that `CAPTURE_BAND_FRACTION`, `safeBottomInset()` and `zone()` were retired by entry 52, which made a single tap save anywhere; entry 103 then removed tap-to-save outright. Nothing of the region survives, and that is the correct outcome — the band existed to keep saving away from playing, and the eventual answer was to stop a tap saving at all.
